...
namespace HotChocolate.Example.Infrastructure.Migrations
{
    ...
    [Migration("20230515212046_Update-Address-Street")]
    partial class UpdateAddressStreet
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotChocolate.Example.Domain.Entities.Address", b =>
                {
                    ...
                    b.HasIndex(new[] { "Street", "City", "StateProvince", "PostalCode", "CountryRegion" }, "IX_Address_AddressLine1_AddressLine2_City_StateProvince_PostalCode_CountryRegion");
            ...
            modelBuilder.Entity("HotChocolate.Example.Domain.Entities.BuildVersion", b =>
                {
            ...
            modelBuilder.Entity("HotChocolate.Example.Domain.Entities.Customer", b =>
                {
            ...
            modelBuilder.Entity("HotChocolate.Example.Domain.Entities.CustomerAddress", b =>
                {
                    b.Property<int>("CustomerId")
                        .HasColumnType("int")
                        .HasColumnName("CustomerID")
            ...
            modelBuilder.Entity("HotChocolate.Example.Domain.Entities.ErrorLog", b =>
                {
            ...
            modelBuilder.Entity("HotChocolate.Example.Domain.Entities.SalesOrderDetail", b =>
                {
            ...
            modelBuilder.Entity("HotChocolate.Example.Domain.Entities.SalesOrderHeader", b =>
                {
                    b.Property<int>("SalesOrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HotChocolate.Example.Domain.Entities.VGetAllCategory", b =>
                {
            ...
            modelBuilder.Entity("HotChocolate.Example.Domain.Entities.VProductAndDescription", b =>
                {
                    b.Property<string>("Culture")
                        .IsRequired()
                        .HasMaxLength(6)
            ...
            modelBuilder.Entity("HotChocolate.Example.Domain.Entities.VProductModelCatalogDescription", b =>
                {
            ...
            modelBuilder.Entity("HotChocolate.Example.Domain.Entities.CustomerAddress", b =>
                {
                    b.HasOne("HotChocolate.Example.Domain.Entities.Address", "Address")
                        .WithMany("CustomerAddresses")
                        .HasForeignKey("AddressId")
                        .IsRequired();

                    b.HasOne("HotChocolate.Example.Domain.Entities.Customer", "Customer")
                        .WithMany("CustomerAddresses")
            ...
            modelBuilder.Entity("HotChocolate.Example.Domain.Entities.SalesOrderDetail", b =>
                {
                    b.HasOne("HotChocolate.Example.Domain.Entities.Product", "Product")
                        .WithMany("SalesOrderDetails")
                        .HasForeignKey("ProductId")
                        .IsRequired();

                    b.HasOne("HotChocolate.Example.Domain.Entities.SalesOrderHeader", "SalesOrder")
                        .WithMany("SalesOrderDetails")
            ...
            modelBuilder.Entity("HotChocolate.Example.Domain.Entities.SalesOrderHeader", b =>
                {
                    b.HasOne("HotChocolate.Example.Domain.Entities.Address", "BillToAddress")
                    ...
                    b.HasOne("HotChocolate.Example.Domain.Entities.Address", "ShipToAddress")
